...
<head>
    ...
    <title>Manajemen Halaman - Dedikasi Malang CMS</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-x-auto">
            ...
            <header class="bg-primary-yellow shadow-md">
                <div class="px-6 py-3">
                    <h1 class="text-3xl font-bold text-gray-800">Manajemen Halaman Statis</h1>
                </div>
            </header>
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="relative w-full max-w-sm">
                        ...
                        <input
                            ...
                            placeholder="Cari berdasarkan judul, slug...">
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!-- Contoh Baris 1 -->
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Tentang Kami</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">/tentang-kami</td>
                            ...
                            <!-- Contoh Baris 2 -->
                            <tr class="bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Visi & Misi</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">/visi-misi</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Published</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            <!-- Contoh Baris 3 -->
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Hubungi Kami</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">/hubungi-kami</td>
                                <td class="px-6 py-4 whitespace-nowrap">
