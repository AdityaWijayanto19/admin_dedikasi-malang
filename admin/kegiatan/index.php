...
<head>
    ...
    <title>Manajemen Kegiatan - Dedikasi Malang CMS</title>
    <!-- Tailwind CSS CDN -->
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Bakti Sosial di Panti Asuhan</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">15 Okt 2025</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Malang</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr class="bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Workshop Digital Marketing</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">22 Okt 2025</td>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Rapat Perencanaan Q4</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2 Nov 2025</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kantor Pusat</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-gray-800">Draft</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="#" class="p-2 rounded-md bg-primary-yellow hover:bg-yellow-400 transition-colors duration-200 inline-block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
